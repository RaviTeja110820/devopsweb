package com.stackroute.oops.league.commander.model;
...
public class PlayerTests {
    ...
    @Test
    public void givenPlayerObjectThenShouldSetProperties() {
    ...
    @Test
    public void givenPlayerObjectThenReturnPlayerDetails() {
    ...
    public void givenPlayerObjectWhenLeagueTitleSetThenAddNewLeagueTitleProperty() {
        ...
        player.setTeamTitle("");
        assertEquals("",player.getTeamTitle(),  MESSAGE_THREE);
